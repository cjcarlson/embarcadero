---
title: "Mapping \textit{Hyalomma} and CCHF in Africa"
output: pdf_document
vignette: >
...
What do the predictions look like? To make a predicted raster, we have to use _embarcadero_'s wrapper for the native _predict_ function in _dbarts_. 
